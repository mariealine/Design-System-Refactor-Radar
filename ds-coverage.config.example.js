 ...
 *
 * All values below are examples — customize patterns to match YOUR design system.
...
export default {
  ...
  // Each mapping declares source → target with complexity and guidelines.
  //
  migration: {
    ...
    mappings: [
      ...
      //   complexity: "simple",
      //   guidelines: "1. Update import path\n2. Rename 'intent' prop to 'variant'\n3. Remove 'isLoading' — use 'disabled' + spinner icon instead",
      //   propMapping: "intent → variant, isLoading → disabled",
      //   effort: "~15min",
      // },
      // {
      //   source: "Modal",
      ...
      //   propMapping: "isOpen → open, onClose → onOpenChange, title → DialogTitle children",
      //   breakingChanges: [
      //     "Modal used imperative open/close — Dialog uses declarative open state",
