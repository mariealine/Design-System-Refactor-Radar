/**
 * Design System Assistant — Example configuration
 *
 * This file is auto-generated by `npx design-system-assistant init`.
 * You can also copy it manually and customize it.
 *
 * Run the interactive wizard: `npx design-system-assistant init`
 * Or create this file manually and run: `npx design-system-assistant init --no-interactive`
 *
