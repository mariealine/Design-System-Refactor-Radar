...
### Detected Violations
The scanner checks for: ${violationSummary || "No categories configured — edit ds-coverage.config.js"}
${componentSection}
### Boy Scout Rule
...
Run \`npx ds-coverage --open\` to open the dashboard in the browser.
`;
}
