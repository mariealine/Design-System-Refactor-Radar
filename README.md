...
- **Config** — One file (e.g. `design-system-refactor-radar.config.js` or `design-system-refactor-radar.config.mjs`) defines what to scan, which patterns to check, and where your components live. Run `npx design-system-refactor-radar init` to create it.
