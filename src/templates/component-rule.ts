...
> **This rule is auto-generated by Design System Assistant.** Update your \`design-system-assistant.config\` and re-run \`npx design-system-assistant init --force\` to regenerate.
