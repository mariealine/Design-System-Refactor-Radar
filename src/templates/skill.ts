...
> **Auto-generated by Design System Assistant.** Re-run \`npx design-system-assistant init\` to update.
...
### Detected Violations
The scanner checks for: ${violationSummary || "No categories configured — edit design-system-assistant.config.js"}
${componentSection}
### Boy Scout Rule
...
### Scanner
Run \`npx design-system-assistant\` to generate a coverage report and interactive dashboard.
Run \`npx design-system-assistant --open\` to open the dashboard in the browser.
`;
}
